...
def build_search_query(subject: CheckSubject) -> str:
    template = _CATEGORY_QUERY_TEMPLATES.get(subject.category, _DEFAULT_TEMPLATE)
    return f"{subject.name} {template}"
